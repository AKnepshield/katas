...
def test_list_artists():
    ...
    list_of_artists = collection.list_artists()

    expected_list_of_artists = ["Death Threat", "Trapped Under Ice", "World Be Free"]

    assert sorted(expected_list_of_artists) == sorted(list_of_artists)
